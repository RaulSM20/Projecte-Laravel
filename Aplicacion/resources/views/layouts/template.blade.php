              ...
              <div class="flex items-center justify-between py-4">
                  ...
                  @auth
                      ...
                      <div class="hidden sm:flex sm:items-center">
                          ...
                          <a href="{{url('/retos')}}" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Retos</a>
                          <a href="{{url('/logros')}}" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Logros</a>
                          <a href="{{url('/entrenar')}}" class="text-gray-800 text-sm font-semibold hover:text-purple-600">Entrenar</a>
                      </div>
                  @endauth
                  ...
                  <div class="hidden sm:flex sm:items-center gap-3">
                      ...
                      @auth
                          @if (auth()->user()->hasRole('admin'))
                              ...
                              <a href="{{ url('/dashboard') }}" class="text-gray-800 text-sm font-semibold">Dashboard</a>
   ...
   <footer class="bg-gray-800 text-white p-8">
      <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-y-2 md:space-y-0 md:space-x-4">
          ...
          <a href="{{url('/contacto')}}" class="hover:text-gray-300">Contacto</a>
          <a href="{{url('/privacidad')}}" class="hover:text-gray-300">Política de privacidad</a>
          <a href="{{url('/terminos')}}" class="hover:text-gray-300">Términos y condiciones</a>
        </div>
      </div>
   </footer>
