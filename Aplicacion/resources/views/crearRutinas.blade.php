            ...
            <div class=" bg-gray-500 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-800">
                    <div class="max-w-md mx-auto">
                        <form action="{{route('rutinas.store')}}" class=" shadow-md rounded px-8 pt-6 pb-8 mb-4"
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="nombre" type="text" placeholder="Nombre de la rutina" name="nombre">
                            </div>
                            <div class="mb-4">
                                ...
                                <input
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="dificultad" type="text" placeholder="Nivel de dificultad" name="dificultad">
                            </div>
